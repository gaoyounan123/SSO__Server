			...
			<form:form method="post" id="fm1" cssClass="fm-v clearfix" commandName="${commandName}" htmlEscape="true">
                ...
                <!-- <spring:message code="screen.welcome.welcome" /> -->
                    ...
                    <div class="row btn-row">
                        ...
                        <input class="btn-reset" name="reset" accesskey="c" value="<spring:message code="screen.welcome.button.clear" />" tabindex="5" type="reset" /><br/>
                        <a href="http://35.183.16.230:8080/signup" >Signup</a>
                    </div>
            </form:form>
          </div>
            <div id="sidebar">
